...
export function modelTargetId(providerId: string, model: string): string {
  return `${providerId}:${model}`
}

export function parseTargetId(id: string): { providerId: string; model: string; variant?: string } {
